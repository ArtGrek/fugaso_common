...
use fugaso_math_ed6::config::thunder_express as gconf;
use fugaso_math_ed6::math::ThunderExpressMath;
use fugaso_math_ed6::rand::MockThunderExpressRand;
...
const GAME_NAME: &str = "thunderexpress";
const GAME_FOLDER: &str = "thunder_express";
type Math = ThunderExpressMath<MockThunderExpressRand>;
...
async fn create_server_cfg() -> TestConfig {
    ...
    let mut rand = MockThunderExpressRand::new();
    ...
    let math = ThunderExpressMath::configured(rand).expect("math load error!");
